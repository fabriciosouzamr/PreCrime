<%@ Page Title="" Language="C#" MasterPageFile="~/Master1.Master" AutoEventWireup="true" CodeBehind="pagAvaliacaoPiscologiaListagem.aspx.cs" Inherits="PreCrime.pagAvaliacaoPiscologiaListagem" %>
    ...
    <form class="form-horizontal" role="form" runat="server">
        <fieldset>
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-12">
                        <asp:Label ID="lblTitulo" runat="server" Font-Bold="true" Font-Size="Large">Pesquisa de Avaliações Psicológicas</asp:Label>
                        <br />
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row" style="padding-top: 20px">
                    ...
                    <div class="col-lg-4">
                        <asp:button id="cmdPendentes" runat="server" text="Pesquisas Pendentes de Avaliação" style="vertical-align:bottom;" OnClick="cmdPendentes_Click" class="btn btn-lg btn-primary btn-block"></asp:button>
                    </div>
                    <div class="col-lg-2">
                    ...
                    <div class="col-lg-2">
                        <asp:button id="cmdLimparFiltro" runat="server" text="Limpar Filtro" style="vertical-align:bottom;" OnClick="cmdLimparFiltro_Click" class="btn btn-lg btn-primary btn-block"></asp:button>
                    </div>
                </div>
            </div>
        </fieldset>
        <div class="row" runat="server" style="padding-top: 10px">
            <div class="table-responsive col-md-12" runat="server">
                <asp:GridView ID="grdItens"
                                ...
                                BorderWidth="0">
                    <Columns>
                        <asp:BoundField DataField="cd_entrevistado_cpfcnpj" HeaderText="U.F." ItemStyle-Width="50px" />
                        <asp:BoundField DataField="no_entrevistador_endereco_cidade" HeaderText="Cidade" ItemStyle-Width="250px" />
                        <asp:BoundField DataField="ds_entrevistador_endereco_bairro" HeaderText="Bairro" ItemStyle-Width="250px" />
                        ...
                        <asp:BoundField DataField="no_statusavalicao" HeaderText="Status da Avaliação" ItemStyle-Width="250px" />
                        <asp:BoundField DataField="dt_avaliacao" HeaderText="Data" ItemStyle-Width="50px" />
