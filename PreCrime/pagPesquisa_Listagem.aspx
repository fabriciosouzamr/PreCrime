<%@ Page Title="" Language="C#" MasterPageFile="~/Master1.Master" AutoEventWireup="true" CodeBehind="pagPesquisa_Listagem.aspx.cs" Inherits="PreCrime.pagPesquisa_Listagem" %>
        ...
        <div class="row" runat="server" style="padding-top: 10px">
            <div class="table-responsive col-md-12" runat="server">
                <asp:GridView ID="grdItens"
                                ...
                                BorderWidth="0">
                    <Columns>
                        <asp:BoundField DataField="cd_cpfcnpj" HeaderText="C.P.F." ItemStyle-Width="100px" />
                        ...
                        <asp:BoundField DataField="dt_resposta" HeaderText="Data Pesquisa" ItemStyle-Width="50px" />
                        <asp:BoundField DataField="no_entrevistador_pessoa" HeaderText="Entrevistador" ItemStyle-Width="250px" />
