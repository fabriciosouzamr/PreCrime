...
namespace PreCrime
{
    public partial class pagPessoa_Pesquisa : System.Web.UI.Page
    {
        ...
        {
            if (clsFuncao.Session_Valor(Session, Constantes.cons_Sessao_Pessoa_RequestPessoaPesquisa, "").ToString() != "")
            {
                var button = (((Button)sender));
                var customer = button.CommandArgument;

                string sUrl = clsFuncao.Session_Valor(Session, Constantes.cons_Sessao_Pessoa_RequestPessoaPesquisa, "").ToString();
